...
import type { HeroBanner, HeroBannerImage } from "@Types/heroBanner";

/**
 * Contentful content model (id: "heroBanner")
 *
 *   heading        Symbol/Text      "Heading" â€” main hero headline
 *   logo           Asset            "Partner logo" rendered above the headline
 *   productImage   Asset            product/feature image on the right
 *   ctaText        Symbol           "CTA Text" â€” label for the read-more link
 *   ctaUrl         Symbol           optional â€” link destination (no link rendered if missing)
 */
