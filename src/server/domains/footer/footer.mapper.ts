...
} from "@/contracts/footer";

/**
 * Contentful content model (id: "footer")
 *
 *   name              Symbol         // internal
 *   quickLinks        Reference → quickLinks   { title, links[] → navItem }
 *   columns           Reference[] → footerColumn   { title, links[] → navItem }
 *   connectWithUs     Reference → connectWithUs
 *                       { title, socialLinks[] → socialLink,
 ...
 *   footerBottom      Reference → footerBottom
 *                       { copyrightText, copyrightUrl, legalLinks[] → navItem }
 *
