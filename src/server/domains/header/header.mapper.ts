 ...
 *   allProductsNav        Reference → navItem      (the red "All Products" button)
 *   navigationItems       Reference[] → navItem    (top-row nav)
 *   locales               Reference[] → locale
 ...
 *   utilityLinks          Reference[] → navItem    optional (e.g. Contact Us)
 *
 *   navItem fields:        label (Symbol), url (Symbol, optional),
 *                          external (Boolean, optional),
 *                          children (Reference[] → navItem, optional)
 *   locale fields:         label (Symbol), url (Symbol),
 *                          code (Symbol, optional), flag (Asset, optional)
 *
 * Every field is optional in this mapper — if it's missing the header still
