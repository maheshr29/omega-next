...
const STORY_CARD = {
  ...
  href: "/about-us",
  imageSrc:
    "https://assets.omega.com/homepage-assets/help-and-resources/helpandresources-dwyeromegastory.png",
  imageAlt: "DwyerOmega measurement equipment",
};

const PERSON_IMAGE = {
  src: "https://assets.dwyeromega.com/homepage-assets/help-and-resources/helpandresources-contactus.png",
